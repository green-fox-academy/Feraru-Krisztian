...
SELECT DISTINCT book_name, aut_name, cate_descrip, pub_name, book_price FROM book_mast
...
WHERE book_mast.book_name = book_mast.book_name AND book_mast.book_price = book_mast.book_price;
